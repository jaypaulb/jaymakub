...
SELECTED_TERMINAL_APPS="Azure CLI,Claude CLI,Gemini CLI,GitHub CLI,GitLab CLI,LazyDocker,LazyGit,Salesforce CLI,Zellij"
...
if [[ "$XDG_CURRENT_DESKTOP" == *"GNOME"* ]]; then
  ...
  SELECTED_DESKTOP_APPS="Alacritty,Bitwarden,Chrome,Flameshot,Gnome Sushi,Gnome Tweaks,LocalSend,OBS Studio,OnlyOffice,Pinta,Synergy,Typora,VLC,Xournal++"
